                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                           ...
                           <form action="{{ route('house.update') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input id="name" name="danatitle" placeholder="Title" value="{{ $home->danatitle }}"
                                    type="text" class="form-control validate">
                            </div>
                            <div class="form-group mb-3">
                                <label for="">About us Description</label>
                                <textarea  name ="description" class="form-control validate" rows="8" name="aboutdesc"
                                    placeholder="Write some text..."
                                    spellcheck="false">{{ $home->description }}</textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label for="">About Us Title 1
                                </label>
                                <input id="name" name="author" placeholder="author" value="{{ $home->author}}"
                                    type="text" class="form-control validate">
                            </div>
                            <div class="form-group mb-3">
                                <div>
                                 ...
                                 <span class="input-group-btn">
                                     <a id="lfm" data-input="thumbnail" data-preview="holder"
                                        ...
                                        <input id="thumbnail" class="form-control" type="text" name="photo" value="{{ $home->photo }}">
                                    </div>
