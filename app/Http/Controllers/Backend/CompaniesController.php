...
class CompaniesController extends Controller
{
    ...
    {
        $company=Companies::orderby('id','DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            return redirect()->route('admincompany.index')->with('success','Company Created Successfully');
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($company){
            ...
            if($status){
                return redirect()->route('admin.company.index')->with('success','Company successfully updated');
            }
            else{
                return back()->with('error','Something went wrong!');
            }
    ...
    public function destroy($id)
    {
        ...
        if($company){
            ...
            if($status){
                return redirect()->route('admincompany.index')->with('success','Company delete Successfully');
            }
